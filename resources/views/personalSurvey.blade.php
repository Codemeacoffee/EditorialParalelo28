...
<!-- P E R S O N A L   S U R V E Y -->

<div class="container-fluid mt-5">
    <h1 class="text-center mb-5"><strong>Encuesta de Satisfacción</strong></h1>
    <?php

    if(Count($data['questions']) > 0) echo '<h5 class="text-center mb-5">Bienvenido a tu encuesta de satisfacción personal <strong>'.$data['name'].'</strong>.</h5>';
            ...
            if(Count($data['questions']) > 0){
                ...
                foreach ($data['questions'] as $question){
                    ...
                    switch ($question['type']){
                        ...
                        default:
                            $subIndex = 1;
                            foreach ($data['possibleAnswers'] as $possibleAnswers){
                ...
                echo '<img alt="Icono informando de que ya ha completado esta encuesta." class="w-50 centerHorizontal" src="'.asset('images/surveyCompleated.png').'">
                  <h5 class="text-center mb-5">¡Muchas gracias por completar nuestra encuesta de satisfacción <strong>'.$data['name'].'</strong>!</h5>
...
<!-- E N D   P E R S O N A L   S U R V E Y  -->
